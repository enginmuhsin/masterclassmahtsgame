...
if secim == "🎮 Oyun Modu":
    ...
    if st.session_state.hedef_sayi != 0 and not st.session_state.oyun_aktif and kalan_sure <= 0:
    ...
    if st.sidebar.button("🎲 YENİ OYUN BAŞLAT (SIFIRLA