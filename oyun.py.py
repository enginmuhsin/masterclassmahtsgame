...
if secim == "🎮 Oyun Modu":
    ...
    # --- İLK YÜKLEMEDE OTOMATİK BAŞLATMA MANTIĞI SİLİNDİ ---
    ...
    # --- YENİ EKLENEN KARŞILAMA EKRANI ---
        ...
        with col_start2:
            ...
            if st.button("🚀 OYUNU BAŞLAT", key="main_start_button", type="primary", use_container_width=True):
                yeni_oyun_baslat() # Oyunu başlatır ve hedef sayı atanır
                st.rerun() # Sayfayı yeniler ve oyun arayüzünü gösterir
